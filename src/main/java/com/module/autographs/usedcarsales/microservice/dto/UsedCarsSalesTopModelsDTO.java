...
public class UsedCarsSalesTopModelsDTO {
    ...
    public UsedCarsSalesTopModelsDTO() {
    }


    public UsedCarsSalesTopModelsDTO(String id, String year, String quarter, String topRank, String model, String usedCarsQuarterlySalesTopModelCount, String percentage, String quarterlyPercentage) {
        this.id = id;
        this.year = year;
