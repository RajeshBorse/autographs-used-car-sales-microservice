...
public class UsedCarsSalesTopRegionsDTO {
    ...
    public UsedCarsSalesTopRegionsDTO() {
    }

    public UsedCarsSalesTopRegionsDTO(String id, String year, String quarter, String topRank, String region, String usedCarsQuarterlySalesTopRegionCount, String percentage, String quarterlyPercentage) {
        this.id = id;
        this.year = year;
    ...
    public String toString() {
        return "UsedCarsSalesTopRegionsDTO{" +
                "id='" + id + '\'' +
                ", year='" + year + '\'' +
                ", quarter='" + quarter + '\'' +
                ", topRank='" + topRank + '\'' +
